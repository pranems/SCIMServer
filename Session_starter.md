...
## Current Focus
All phases through Phase 9 (Bulk Operations) complete. G8b (Custom Resource Type Registration), G8c (PATCH readOnly), G8e (returned characteristic filtering), G8f (Group uniqueness PUT/PATCH), G8g (write-response attribute projection) — all CLOSED. Current version v0.19.2 with 2,357 unit (69 suites), 455 E2E (22 suites), 444 live tests — all passing. Next priorities: remaining RFC gaps (Sorting, /Me endpoint) and operational improvements.
