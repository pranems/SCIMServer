...
## Current Focus
All 27 migration gaps (G1–G20) fully resolved. v0.29.0: Fixed 19 test failures, removed legacy config field, added multi-endpoint isolation E2E tests. Endpoint profile configuration — unified profile JSONB, 5 built-in presets, Prisma 7→5 models, endpoint-profile module. README, docs, and all JSONs recreated from source on 2026-03-16. **Remaining P0 gaps:** legacy token backdoor in scim-auth.guard.ts, console.log statements, CORS origin:true, /scim/v2 rewrite middleware. Current version v0.29.0 — all unit (2,906 / 73 suites), E2E (698 / 33 suites) passing. Live: 621 assertions. 📊 See [PROJECT_HEALTH_AND_STATS.md](docs/PROJECT_HEALTH_AND_STATS.md#test-suite-summary) for current counts.
