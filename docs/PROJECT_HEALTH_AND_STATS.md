...
| Class | Lines | Purpose |
|---|---|---|
| `SchemaValidator` | 816 | RFC 7643 payload validation (8 types, mutability, required, limits) |
...
| **Feature Flags** | Per-endpoint config flags | 9 flags: `SoftDeleteEnabled`, `StrictSchemaValidation`, etc. |
...
| Phase 8.x | Remaining Gaps (V1, V16, V32) | 🔄 In Progress | v0.17.2+ |
| Phase 9+ | Custom Resource Types | Not Started | — |
...
| No Bulk endpoint | LOW | RFC 7644 Bulk operations not implemented |
...
| Area | Suggestion | Estimated Effort |
|---|---|---|
| **Bulk endpoint** | RFC 7644 §3.7 Bulk operations | 3-5 days |
...
| All tests passing | Yes (2,669/2,670) | 1 pre-existing known |
