...
> 62 active docs in `docs/` · 45 E2E suites (939 pass) · 80 unit suites (3,193 pass) · 6 built-in presets
...
| [SCHEMA_CUSTOMIZATION_GUIDE.md](SCHEMA_CUSTOMIZATION_GUIDE.md) | Operator guide — custom schemas, extensions, resource types |
...
| Document | Description |
|----------|-------------|
| [P4_ATTRIBUTE_CHARACTERISTIC_DEEP_ANALYSIS.md](P4_ATTRIBUTE_CHARACTERISTIC_DEEP_ANALYSIS.md) | **Latest (v0.34.0)** — source-verified gap analysis, 19 gaps, 3 actionable fixes |
