...
| 2026-06-18 | A0 DONE. profile.authentication model (AuthenticationMethod + ProfileAuthentication) threaded through expandProfile with no-secret strip. 12 unit + 5 E2E + 8 live (9z-AN). API unit 3856->3866; endpoint/profile E2E 87; local live 1049/0. Version -> 0.54.0-alpha.3. |
