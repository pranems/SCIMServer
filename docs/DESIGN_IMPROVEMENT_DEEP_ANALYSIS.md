...
|--------|------:|:----------:|
| Unit tests | 3,200 (80 suites) | ✅ Excellent coverage |
| E2E tests | 939 (45 suites) | ✅ Comprehensive |
| Live tests (main) | ~739 (43 sections) | ✅ Deployment verification |
| Live tests (Lexmark ISV) | 112 (13 sections) | ✅ Vendor-specific validation |
| **Total** | **~4,990** | ✅ Production-grade |
