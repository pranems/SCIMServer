...
export const USER_SCHEMA_ATTRIBUTES = [
  ...
  },
  {
    ...
    subAttributes: [
      { name: 'formatted', type: 'string', multiValued: false, required: false, caseExact: false, mutability: 'readWrite', returned: 'default', description: 'The full name.' },
      { name: 'familyName', type: 'string', multiValued: false, required: false, caseExact: false, mutability: 'readWrite', returned: 'default', description: 'The family name.' },
      { name: 'givenName', type: 'string', multiValued: false, required: false, caseExact: false, mutability: 'readWrite', returned: 'default', description: 'The given name.' },
      { name: 'middleName', type: 'string', multiValued: false, required: false, caseExact: false, mutability: 'readWrite', returned: 'default', description: 'The middle name.' },
      { name: 'honorificPrefix', type: 'string', multiValued: false, required: false, caseExact: false, mutability: 'readWrite', returned: 'default', description: 'The honorific prefix.' },
      { name: 'honorificSuffix', type: 'string', multiValued: false, required: false, caseExact: false, mutability: 'readWrite', returned: 'default', description: 'The honorific suffix.' },
    ],
  },
  {
    name: 'displayName',
  ...
  },
  {
    ...
    subAttributes: [
      { name: 'formatted', type: 'string', multiValued: false, required: false, caseExact: false, mutability: 'readWrite', returned: 'default', description: 'The full street address.' },
      { name: 'streetAddress', type: 'string', multiValued: false, required: false, caseExact: false, mutability: 'readWrite', returned: 'default', description: 'The street address component.' },
      { name: 'locality', type: 'string', multiValued: false, required: false, caseExact: false, mutability: 'readWrite', returned: 'default', description: 'The city or locality component.' },
      { name: 'region', type: 'string', multiValued: false, required: false, caseExact: false, mutability: 'readWrite', returned: 'default', description: 'The state or region component.' },
      { name: 'postalCode', type: 'string', multiValued: false, required: false, caseExact: false, mutability: 'readWrite', returned: 'default', description: 'The zip or postal code component.' },
      { name: 'country', type: 'string', multiValued: false, required: false, caseExact: false, mutability: 'readWrite', returned: 'default', description: 'The country name component.' },
      { name: 'type', type: 'string', multiValued: false, required: false, caseExact: false, mutability: 'readWrite', returned: 'default', canonicalValues: ['work', 'home', 'other'], description: 'Label (e.g., "work", "home").' },
  ...
  },
  {
    ...
    subAttributes: [
      { name: 'value', type: 'string', multiValued: false, required: false, caseExact: false, mutability: 'readWrite', returned: 'default', description: 'Instant messaging address value.' },
      { name: 'type', type: 'string', multiValued: false, required: false, caseExact: false, mutability: 'readWrite', returned: 'default', canonicalValues: ['aim', 'gtalk', 'icq', 'xmpp', 'msn', 'skype', 'qq', 'yahoo'], description: 'Label (e.g., "aim", "gtalk").' },
  ...
  },
  {
    ...
    subAttributes: [
      { name: 'value', type: 'reference', multiValued: false, required: false, caseExact: false, mutability: 'readWrite', returned: 'default', referenceTypes: ['external'], description: 'URL of a photo of the User.' },
      { name: 'type', type: 'string', multiValued: false, required: false, caseExact: false, mutability: 'readWrite', returned: 'default', canonicalValues: ['photo', 'thumbnail'], description: 'Label (e.g., "photo", "thumbnail").' },
  ...
  },
  {
    ...
    subAttributes: [
      { name: 'value', type: 'string', multiValued: false, required: false, mutability: 'readWrite', returned: 'default', description: 'The entitlement value.' },
      { name: 'display', type: 'string', multiValued: false, required: false, mutability: 'readWrite', returned: 'default', description: 'The display name.' },
      { name: 'type', type: 'string', multiValued: false, required: false, mutability: 'readWrite', returned: 'default', description: 'The type label.' },
  ...
  },
  {
    ...
    subAttributes: [
      { name: 'value', type: 'binary', multiValued: false, required: false, mutability: 'readWrite', returned: 'default', description: 'The DER-encoded X.509 certificate value.' },
      { name: 'display', type: 'string', multiValued: false, required: false, mutability: 'readWrite', returned: 'default', description: 'The display name.' },
      { name: 'type', type: 'string', multiValued: false, required: false, mutability: 'readWrite', returned: 'default', description: 'The type label.' },
...
export const GROUP_SCHEMA_ATTRIBUTES = [
  ...
  },
  {
    ...
    subAttributes: [
      ...
      { name: '$ref', type: 'reference', multiValued: false, required: false, caseExact: false, mutability: 'immutable', returned: 'default', referenceTypes: ['User', 'Group'], description: 'The URI of the corresponding resource.' },
