...
| Key | Value |
|---|---|
| Version | [`v0.17.2`](https://github.com/pranems/SCIMServer/releases/latest) |
...
Update-SCIMServer -Version v0.17.2 -ResourceGroup <rg> -AppName <app>
```
...
- Unit tests: **2096/2096** (61 suites)
- E2E tests: **368/368** (19 suites)
