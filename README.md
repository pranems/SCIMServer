...
| Key | Value |
|---|---|
| Version | [`v0.24.0`](https://github.com/pranems/SCIMServer/releases/latest) |
...
Update-SCIMServer -Version v0.24.0 -ResourceGroup <rg> -AppName <app>
```
...
- **All unit, E2E, and live integration tests passing** (100% pass rate)
