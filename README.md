...
**121 route handlers** across 33 controllers. Full reference with request/response examples: [docs/COMPLETE_API_REFERENCE.md](docs/COMPLETE_API_REFERENCE.md)
...
|----------|-------------|
| [COMPLETE_API_REFERENCE.md](docs/COMPLETE_API_REFERENCE.md) | All 121 route handlers, full request/response examples |
